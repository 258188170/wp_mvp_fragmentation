package com.example.wp.wp_mvp_fragmentation.mvp.testviews.bezier;
...
public class Bezier3 extends View {
    ...
    private float mCount = 100;//将时长总共化成多少份
    ...
    private void drawCoordinateSystem(Canvas canvas) {
        canvas.save();
        canvas.translate(centerX,centerY);//将坐标系移动到画布中间
        canvas.scale(1,-1);//翻转y轴
        ...
        canvas.drawLine(0, -2000, 0, 2000, helperPaint);
        canvas.drawLine(-2000, 0, 2000, 0, helperPaint);
